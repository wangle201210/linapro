...
type PluginDynamicItem struct {
	Id           string                  `json:"id" dc:"Plugin unique identifier" eg:"linapro-demo-dynamic"`
	...
	StatusKey    string                  `json:"statusKey" dc:"The location key name of the plugin status in the system plugin registry" eg:"sys_plugin.status:linapro-demo-dynamic"`
