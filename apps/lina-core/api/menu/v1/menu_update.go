...
type UpdateReq struct {
	...
	Visible    *statusflag.Visibility `json:"visible" v:"in:0,1" dc:"Whether to display: 1=show 0=hide" eg:"1"`
	Status     *statusflag.Enabled    `json:"status" v:"in:0,1" dc:"Status: 1=normal 0=disabled" eg:"1"`
