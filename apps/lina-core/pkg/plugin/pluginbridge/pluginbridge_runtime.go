// This file defines dynamic-plugin bridge runtime helpers, controller dispatch,
// request/response binding, raw host-call transport, and guest-side host-service
// capability clients.
