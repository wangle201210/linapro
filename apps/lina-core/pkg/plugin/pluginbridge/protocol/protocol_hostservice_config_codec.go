// This file implements shared configuration key and value payload codecs used
// by plugins.config.get and hostConfig.get.
...
// MarshalHostServiceConfigKeyRequest encodes one configuration key request.
...
// UnmarshalHostServiceConfigKeyRequest decodes one configuration key request.
...
// MarshalHostServiceConfigValueResponse encodes one configuration value response.
...
// UnmarshalHostServiceConfigValueResponse decodes one configuration value response.
