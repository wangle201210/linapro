...
// PluginTableFilterService defines source-plugin-only tenant filtering for
// plugin-owned tables. It intentionally stays out of ordinary Service
// because it works on host-process database query builders.
type PluginTableFilterService interface {
