...
// own tenant or plugin-governance modules. Dynamic plugins can consume these
// methods only through explicit plugins host-service method authorization.
...
// LifecycleRunner defines the host capability used by plugin lifecycle
