// This file implements cachecoord-backed runtime cache revision control.
...
// WithTenantScope returns a controller copy with tenant invalidation scope applied.
func (c *Controller) WithTenantScope(tenantID tenantcap.TenantID, cascadeToTenants bool) *Controller {
	if c == nil {
		return nil
	}
	clone := *c
	clone.tenantScope = cachecoord.InvalidationScope{
...
// configureRuntimeCacheDomain declares runtime cache consistency policy in the
// package that owns revision coordination semantics.
