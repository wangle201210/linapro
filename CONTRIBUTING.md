    ...
    <plugin-id>/     -> Source plugin directory (standard structure)
      backend/       -> Plugin backend entry and implementation
        ...
        internal/    -> Plugin backend internal implementation
          ...
          service/    -> Business logic layer
          dao/        -> Data access layer (generated by gf gen dao when needed)
...
- Controller files are scaffolded by `gf gen ctrl`; fill in business logic only and do not change the generated skeleton.
